...
{
    public partial class FormKitapSil : Form
    {
        ...
        private void metroButton1_Click(object sender, EventArgs e)
        {
            baglanti.Open();
            komut.Connection = baglanti;
            komut.CommandText = "(delete from Kitaplar where KitapAdı = '" + textBox1.Text + "')";
        ...
        private void FormKitapSil_Load(object sender, EventArgs e)
        {
            verilerigöruntule();
        }
